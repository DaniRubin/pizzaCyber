(function() {
    ...
    app.directive('pizza', function(){
        ...
        return {
            ...
            controller: ['$http', function($http){
                var alertDiv = '<div class="alert alert-${alertType} alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true"> &times;</button>${msg}</div>';
